...
const ResetPassword = () => {
  ...
  const handleSendReset = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/auth/send-reset`, { email });
  ...
  const handleVerifyReset = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/auth/verify-reset`, {
        email,
        otp,
        newPassword,
      });
